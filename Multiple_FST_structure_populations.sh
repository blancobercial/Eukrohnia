...
#this script creates folders for the outfiles, and runs the STACKS populations using a whitelist of SNPs. 
...
##your populations map, your whitelist (in this case, already filtered by MAF=0.05, so there is no need to indicate; 
...
##I suppose there is a way to make this more efficient - please let me know if you know how to do it! 
